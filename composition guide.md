...
Working rules for prose in `main.ipynb` and `appendix_E.ipynb`(text cells, appendices, and in-code comments), `sections_3-5_outline.md`, and `background_sections_outline.md`.
