"""SMOOTH-MASK CONTROL (exclusion_sharpness = 0.1, Code Cell 2's Sec. 1 control). The four criteria as the grid gets COARSER than K = 101, against fine-grid references.
...
net = LexicalPredictiveCodingNetwork(exclusion_sharpness=0.1)
