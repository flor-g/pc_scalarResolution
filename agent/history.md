...
removed. Records opened since are written in `agent/` and folded in here as they close (§§17–22
on 2026-09-24).
...
| 19 | [The computational complexity of the simulation, and cost in the dynamics](#r19) | 2026-09-24 16:35 | 2026-09-24 | 13 | I14, A22, E20; revisions.md §§17–18 |
| 20 | [Cost, attribution and scope, after an external review](#r20) | 2026-09-24 20:06 | 2026-09-24 | 2 | A22, A17, B11, I14, E1, E21 findings; CF2, CF3; revisions.md §19 |
| 21 | [The central claim reframed by the three questions, and the terms kept apart](#r21) | 2026-09-24 | 2026-09-24 | 8 | C10, C11; B12 finding; revisions.md §20 |
| 22 | [The introduction brought into line with C10 and C11](#r22) | 2026-09-24 | 2026-09-24 | 2 | C10 findings; revisions.md §20 |
...
## 19. The computational complexity of the simulation, and cost in the dynamics

*Was* `agent/complexity_2026-09-24.md` (folded under `agent/agent.md` §5.3 on 2026-09-24)

**Opened** 2026-09-24 16:35 · **Closed** 2026-09-24 · 13 commits to the record; the change itself is
`0475a21`, `ec2eb0d` (Appendix G, Code Cell G, the §5.5 bullet), `cf2a25f` (the three levels),
`a202a6c` (outline §5.4, cost in the dynamics), `3dffadd` (CX5, λ_max(H) blockwise)

**Settled** I14 (the simulation's complexity; its 2026-09-24 findings), A22 (the true cost does not
take part in the dynamics; a proxy may), E20; revisions.md §§17–18. Every task confirmed by the user
and closed; folded at the user's instruction.
...
*Full original:* `git show 11d1a6f:agent/complexity_2026-09-24.md`
...
## 20. Cost, attribution and scope, after an external review

*Was* `agent/review_2026-09-24_cost_and_attribution.md` (folded under `agent/agent.md` §5.3 on 2026-09-24)

**Opened** 2026-09-24 20:06 · **Closed** 2026-09-24 · 2 commits to the record; the change itself is
`91cf560`

**Settled** findings under A22, A17, B11, I14 and E1; CF2 and CF3 resolved; E21; revisions.md §19.
The user's four rulings RVQ1–RVQ4 and the agent's calls confirmed; folded at the user's instruction.

**IDs.** Tasks RV0–RV8, the review's points RP1–RP6, questions RVQ1–RVQ4, findings RVF1–RVF12.
...
The agent's own calls — the wording of the factual fixes (Rao and Ballard, the Gaussian sentence, CF2/CF3, the conclusion's scope), carrying "comes closest to supplying" into the central claim, and not re-executing appendix_E — were **confirmed by the user on 2026-09-24**.
...
- [x] RV8 (2026-09-24): committed as 91cf560; the agent's calls confirmed by the user, the record
      folded here and pushed at the user's instruction.
...
*Full original:* `git show 0b33425:agent/review_2026-09-24_cost_and_attribution.md`

---

<a id="r21" name="r21"></a>

## 21. The central claim reframed by the three questions, and the terms kept apart
...
revisions.md §20. Every task confirmed by the user and closed; folded on closing.
...
## 22. The introduction brought into line with C10 and C11

*Was* `agent/introduction_2026-09-24.md` (folded under `agent/agent.md` §5.3 on 2026-09-24)

**Opened** 2026-09-24 · **Closed** 2026-09-24 · commits `2eb4b05` (the draft and the definition),
`96d3150` (applied)

**Settled** C10's findings on the single feedforward pass and on where the semantic/pragmatic
sub-question belongs; revisions.md §20. Approved by the user and applied; folded on closing.
...
*Full original:* `git show 96d3150:agent/introduction_2026-09-24.md`
