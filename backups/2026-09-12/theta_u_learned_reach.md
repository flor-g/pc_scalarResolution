...
> **Status 2026-09-12: code and prose both done.** T0–T10 are closed. main.ipynb executes clean
> (0 errors, 6 figures, 253 s, 14/14 checks) and appendix_E.ipynb likewise (0 errors, 3 figures,
> 639 s, E2 18/18, E3 PASS). The markdown cells of both notebooks have been rewritten against the
